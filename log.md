...
## [2026-08-17] ingest | POS-EXACT-bridge-claude-code.md -> sop-bridge-claude-code-mac-vps.md (créée) ; concept-hermes-agent, synthese-lumina-ai-os, sop-dream-engine-cron-prescriptions-llm, concept-n8n-credentials (backlinks réciproques ajoutés)
## [2026-08-17] ingest | POS-GENERIQUE-bridge-claude-code.md -> sop-bridge-cli-local-tunnel-serveur-distant.md (créée) ; sop-bridge-claude-code-mac-vps, concept-n8n-credentials (backlinks réciproques ajoutés)
## [2026-08-17] ingest | POS-GENERIQUE-routeur-multi-agent.md -> sop-registre-agents-multi-backends.md (créée) ; concept-routeur-multi-llm, sop-cablage-orchestrateur-subagents, sop-bridge-cli-local-tunnel-serveur-distant, concept-n8n-credentials (backlinks réciproques ajoutés)
## [2026-08-20] ingest | POS-GENERIQUE_interroger-LLM-externe-n8n-webhook_2026-08-17 -> sop-interroger-llm-externe-n8n-webhook.md (créée) ; POS-EXACT_Operator-OS_Canal-query-claude-n8n_2026-08-17 -> sop-operator-query-claude-n8n.md (créée) ; POS-GENERIQUE_deployer-app-FastAPI-Coolify-repo-GitHub-prive_2026-08-17 -> sop-deployer-fastapi-coolify-repo-prive.md (créée) ; POS-EXACT-routeur-multi-agent -> sop-routeur-multi-agent-operator-os.md (créée) ; backlinks réciproques ajoutés dans sop-dream-engine-cron-prescriptions-llm, sop-bridge-claude-code-mac-vps, sop-registre-agents-multi-backends, concept-hermes-agent, concept-limites-api-claude, concept-n8n-credentials, synthese-lumina-ai-os, SOP_installer-pgvector-sur-postgres-coolify, sop-generique-runner-llm-headless-webhook. Note : POS-EXACT_Operator-OS_Dream-Engine-cron-prescriptions_2026-08-17, POS-GENERIQUE_synchroniser-SQLite-entre-deux-conteneurs-Docker_2026-08-17, POS-EXACT-bridge-claude-code.md, POS-GENERIQUE-bridge-claude-code.md et POS-GENERIQUE-routeur-multi-agent.md (parmi les 9 fichiers demandés) étaient déjà compilés lors d'un run précédent (sources: déjà présentes dans les pages wiki correspondantes) — non retraités (dédup).
