# CLAUDE.md — Coffre `ai-automation`
...
API, MCP, agents, prompting, n8n, embeddings, modèles (ChatGPT/Claude/Gemini), RAG, fine-tuning, webhooks, intégrations.
...
```text
ai-automation/
├── CLAUDE.md     ← ce fichier (schéma + workflows)
...
source_url: "https://…  | export-claude | export-chatgpt | note-manuelle"
captured: 2026-06-20
vault: ai-automation
brand: null
tags: [api, mcp]
...
*CLAUDE.md `ai-automation` v2.2 — 2026-06-20. Modifier ce fichier = journaliser dans log.md.*
