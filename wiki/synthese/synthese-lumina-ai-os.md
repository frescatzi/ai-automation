...
updated: 2026-07-06
related: ["SOP_systeme-multi-agents-memoire-centrale-mcp-n8n", "concept-bibliotheque-skills-apprenante", "concept-classification-workflows-n8n", "concept-hermes-agent", "concept-memoire-vectorielle-multi-marques", "concept-memoire-vivante-agents", "concept-pipeline-memoire-wiki-git", "concept-routeur-multi-llm", "sop-bridge-claude-code-mac-vps", "sop-dream-engine-cron-prescriptions-llm", "sop-operator-query-claude-n8n", "sop-routeur-multi-agent-operator-os"]
---
...
- [[sop/sop-bridge-claude-code-mac-vps]] — Operator OS/Hermes interroge Claude Code CLI (Mac) via tunnel Cloudflare.
- [[sop/sop-operator-query-claude-n8n]] — Operator OS interroge l'API Anthropic via un webhook n8n dédié (`/query-claude`).
- [[sop/sop-routeur-multi-agent-operator-os]] — routeur Operator OS qui unifie DeepSeek, Hermes, Claude API et Claude Code derrière une seule UI.
