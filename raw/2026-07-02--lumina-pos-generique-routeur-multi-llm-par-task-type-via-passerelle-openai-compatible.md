---
type: raw
title: "LUMINA — POS GENERIQUE — Routeur multi-LLM par task_type via passerelle OpenAI-compatible"
source_url: "drive:1HfX_gJ9eKh1Fxb2Mv7yzBcfz32WWgKik"
captured: 2026-07-02
vault: ai-automation
brand: null
immutable: true
...
**Cible :** n8n + une passerelle OpenAI-compatible (OpenRouter, ou endpoint local) exposant plusieurs modèles via une clé unique.
...
- Validation croisée (2e modèle) **uniquement** pour livrables externes/critiques (sinon coût x2).
