...
source_url: "dropbox:/apps/lumina ai os/lumina vps/lumina ai/obsidian/lumina inbox/sop_generique_workflow-archivage-idempotent-n8n.md"
captured: 2026-07-21
vault: ai-automation
brand: null
immutable: true
...
- **Vocabulaire de catégories contrôlé** : imposer au classeur amont une **liste fermée** de catégories (sinon il invente des noms qui ne matchent plus les dossiers), avec repli racine pour le hors-liste.
- **Le remote fait foi, le clone local se périme** : l'automate écrit directement sur le remote (`main`) → **synchroniser (`git pull`) avant toute opération locale**, et protéger la purge du manifeste par un **garde-fou de sync** (n'agir que si local = remote, sinon s'abstenir et alerter).
